...
const amountNormalize = (min, max) => (value, previousValue) => {
...
class PaymentFormLayout extends PureComponent {
  ...
  render() {
    const {handleSubmit, onPaymentFormBackClick, isDataLoading, submittedData, isDataSubmitError, onPaymentFormErrorMessageCloseClick} = this.props;
